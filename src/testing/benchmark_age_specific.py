    ...
    for cfg in configs:
        ...
        try:
            ...
            for i, case in enumerate(test_data):
                ...
                logger.info(f"Processing case {i+1}/{len(test_data)} - Age: {age_months}m, Domain: {milestone_context.get('domain', 'unknown')}")
                ...
                if config.run_llm:
                    ...
                    config_results.append({
                        ...
                        "has_domain_specific": milestone_context.get("domain", "").lower() in prompt.lower()
                    })
